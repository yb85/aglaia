...
from lib.gui.widgets import Card
...
class SettingsTab(QWidget):
    ...
    def _build_models_section(self) -> QWidget:
        ...
        from lib.gui.path_reveal import make_label_paths_clickable
        _mdp = _md()
        effective = QLabel(
    ...
    def _build_about_section(self) -> QWidget:
        w = QWidget()
        form = QFormLayout(w)
        from lib.app_data import APP_NAME
        from lib.gui.AboutDialog import app_version
    ...
    def _build_paths_section(self) -> QWidget:
        ...
        # Aglaïa. Implementation lives in lib.app_data.filetype_register.
        reg_row = QHBoxLayout()
    ...
    def _register_filetype(self) -> None:
        from lib.app_data.filetype_register import register_filetype
        ok, msg = register_filetype()
        self._toast_or_message(ok, msg)

    def _unregister_filetype(self) -> None:
        from lib.app_data.filetype_register import unregister_filetype
