...
List cards = the curated modes (lib/app_data/modes.py) + any user-created
...
from lib.app_data import bundled_pipelines_dir, pipelines_dir
from lib.app_data.modes import PipelineMode, mode_for_pipeline, modes
...
from lib.gui.PipelineStepsOutline import PipelineStepsOutline
