...
through the shared renderers (`lib/storage/debug_chain.py`). The strip on
...
from lib.gui.ZoomCanvas import ZoomCanvas, ZoomToolbar
...
from lib.storage.debug_chain import _render_one, _walk_chain
