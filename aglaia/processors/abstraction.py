...
if TYPE_CHECKING:
    ...
    from aglaia.processors.option_specs import ParamSpec
...
class AbstractImageProcessor(ABC):
    ...
    # ── plugin contract (read by aglaia.processors.registry) ──────────────
    ...
    # ── replay contract (read by aglaia.workers.Replay) ───────────────────
    ...
    def __init__(self, options: AbstractProcessorOption):
        ...
        # serialisable. See ``aglaia/workers/oplog.py``.
