...
from aglaia.gui.sidebar import SidebarPanel
...
class MainWindow(QMainWindow):
    ...
    def __init__(self, args, processing_queue, ignored_queue, log_queue,
        ...
        pipeline_path = args.pipeline if args.pipeline else config_path("pipelines", "book_curved_x2.yaml")
        ...
        from aglaia.gui.theme import lucide as _lucide_icn
        ...
        from aglaia.gui.Toast import Toast as _Toast
        self._toast = _Toast(main_widget)

        # Bottom status bar: per-worker RSS bars + pipeline % + last log line.
        from aglaia.gui.StatusBarWidget import StatusBarWidget, LogViewerWidget
    ...
    def _on_report_bug(self) -> None:
        from aglaia.gui.BugReportDialog import open_bug_report
        open_bug_report(self)

    def _on_diagnostics(self) -> None:
        from aglaia.gui.BugReportDialog import open_diagnostics
    ...
    def _reveal_in_finder(self, path: Path) -> None:
        ...
        from aglaia.gui.path_reveal import reveal_path
        reveal_path(path)
    ...
    def _build_capture_placeholder(self) -> QWidget:
        ...
        the project."""
        from aglaia.gui.CameraEnum import list_cameras
    ...
    def _populate_capture_devices(self, ct) -> None:
        ...
        from aglaia.gui.CameraEnum import list_cameras, list_camera_formats
    ...
    def _populate_capture_formats(self, ct, cam_id) -> None:
        ...
        from aglaia.gui.CameraEnum import list_camera_formats
    ...
    def _start_voice(self):
        ...
        try:
            from aglaia.gui.VoiceWorkerVosk import (
    ...
    def _open_freehand_tab(self) -> None:
        ...
        if self._freehand_tab is not None:
            ...
            return
        from aglaia.gui.CalibrationDialogs import FreehandRegistrationDialog
    ...
    def _on_freehand_registered(self, patch, roi) -> None:
        from aglaia.workers.SiftTracker import ClickGate, SiftTracker
    ...
    def _export_slim_project(self):
        ...
        from PySide6.QtWidgets import QFileDialog
        from aglaia.workers.slim_export import slim_export, default_slim_path
        ...
        from aglaia.storage import PROJECT_DIALOG_FILTER
    ...
    def _run_blob_normalizer(self, out_dir: Path):
        from aglaia.workers.BlobNormalizer import compute_scales, apply_scales
        try:
    ...
    def calibrate_dpi(self):
        ...
        if existing is not None:
            ...
            return
        from aglaia.gui.CalibrationDialogs import DpiCalibrationDialog
        from aglaia.workers.CreditCardDPI import ID1_LONG_MM, ID1_SHORT_MM
    ...
    def open_pipeline_editor(self):
        ...
        from aglaia.gui.PipelineEditorWidget import PipelineEditorTab
        from aglaia.gui.theme import lucide as _lucide_tab
    ...
    def _ensure_gallery(self):
        ...
        if self._scans_gallery is None:
            from aglaia.gui.ScansGalleryView import ScansGalleryView
            g = ScansGalleryView(
    ...
    def _on_settings_clicked(self):
        ...
        if self._settings_tab is not None:
            ...
            return
        from aglaia.gui.SettingsTab import SettingsTab
        from aglaia.gui.theme import lucide as _lucide_tab
        tab = SettingsTab()
