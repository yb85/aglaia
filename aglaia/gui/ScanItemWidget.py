...
from aglaia.Status import Status, STATUS_COLORS
...
class ScanItemWidget(QWidget):
    ...
    def _add_nav_buttons(self, container, width, *, stem, is_global):
        from aglaia.gui.widgets import make_icon_button, place_overlay
        from aglaia.gui.colors import COLOR_FONT_INVERSE as _CFI
        nav_kwargs = dict(
    ...
    def _add_disable_toggle(self, container, width, node_info,
        ...
        from aglaia.gui.widgets import place_overlay
        from aglaia.gui.colors import COLOR_FONT_INVERSE as _CFI
        from aglaia.gui.colors import COLOR_BG_OVERLAY_HOVER as _CLOCK
