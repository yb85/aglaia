...
* :class:`FreehandRegistrationDialog` — thin modal wrapper around
  :class:`aglaia.gui.FreehandTab.FreehandRegistrationTab` so the SIFT
...
from aglaia.gui.DpiCalibrationTab import _PickLabel
from aglaia.gui.FreehandTab import FreehandRegistrationTab
...
class DpiCalibrationDialog(QDialog):
    ...
    def _assess_quad(self, quad: np.ndarray) -> tuple[bool, str]:
        ...
        from aglaia.workers.CreditCardDPI import ID1_ASPECT
    ...
    def _finalize(self, quad: np.ndarray) -> None:
        ...
        from aglaia.workers.CreditCardDPI import refine_and_measure
