...
custom widgets need that the base theme doesn't ship:
  ...
  * `Switch` (aglaia.gui.widgets.Switch) — toggle pill rendered via QSS, used
...
from aglaia.assets import asset_path as _asset_path
...
/* ── Custom Switch (aglaia.gui.widgets.Switch) ──────────────────────── */
Switch {{
