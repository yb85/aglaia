...
from aglaia.gui.sidebar.widgets.RadioCardGroup import RadioCardGroup
from aglaia.gui.ModePicker import ModePickerPanel
...
class StartupWindow(QDialog):
    ...
    def _load_recents(self) -> list[tuple[str, str, bool, int | None]]:
        ...
        try:
            ...
            rows = []
        from aglaia.storage import resolve_existing_project_db, is_project_file
