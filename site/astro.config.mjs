      ...
      sidebar: [
        ...
        },
        {
          ...
          items: [
            ...
            { label: 'Destinations', slug: 'docs/reference/destinations' },
            { label: 'Plugin store', slug: 'docs/reference/plugin-store' },
            ...
            { label: 'OCR benchmark', slug: 'docs/reference/ocr-benchmark' },
          ],
        },
      ],
    }),
